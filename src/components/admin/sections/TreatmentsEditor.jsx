...
export default function TreatmentsEditor({ initialContent, initialVisible }) {
  ...
  return (
    <SectionPanel title="Treatments & procedures" description="Treatments intro and the 4 procedure cards" visible={visible} savedVisible={savedVisible} onVisibleChange={setVisible} lastSaved={lastSaved}>
